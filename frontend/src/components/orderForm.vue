    ...
    <div id="orderform">
        <div id="form">
            <form v-on:submit.prevent="submit">
                ...
                <br>
                <h3>Anteprima:</h3><br>
                <img v-for="img in imagePreviews" :src="img" alt="">
                <div class="field">
                    <img type="image" @click="$emit('close')" v-if="submitStatus != sStats.LOADING"
                        style="cursor: pointer;" id="cancelbtn" src="@/assets/imgs/buttons/close-thick.svg" alt="">
    ...
    methods: {
        async submit() {
            try {
                ...
                let response = await this.axios.post(this.submitURL, data);
