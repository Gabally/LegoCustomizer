  ...
  <div id="c-app">
    ...
    <div id="sidemenu">
      ...
      <div id="culo">
        ...
        <div class="opt" id="Testo" v-if="selectedCategory == 'Testo'">
          ...
          <div style="display: flex;">
            <div style="width: 50%;">
              ...
              <br>
              <input type="number" value="30" name="fs" @input="setFontSize" min="1" ref="fontSizeSelector"
                id="fontSize">
            </div>
            <div style="width: 50%;">
              <span>Colore</span>
        ...
        -->
        <canvas-text-editor lass="opt" id="Testo" v-if="selectedCategory == 'Testo'"></canvas-text-editor>
